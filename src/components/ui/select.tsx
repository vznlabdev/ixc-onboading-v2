  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "placeholder:text-gray-500 data-[placeholder]:text-gray-500",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border border-gray-200 bg-white text-gray-950 shadow-lg",
